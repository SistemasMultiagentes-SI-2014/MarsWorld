...
import marsworld.carry.ICarryService;
import marsworld.producer.ProducerBDI.ProduceOre;
...
import marsworld.movement.MovementCapability.Move;
...
//		System.out.println("Produced ore at target: "+getAgentName()+", "+ore+" ore produced.");
    ...
    /**
     * Sending a location to the Producer Agent. Therefore it has first to be
     * looked up in the DF.
     *
     * @param target
     */
