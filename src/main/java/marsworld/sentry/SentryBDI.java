...
import marsworld.BaseBDI;
import marsworld.SVector;
import marsworld.producer.IProduceService;
...
import marsworld.movement.MovementCapability;
...
@ProvidedServices(
        @ProvidedService(type = ITargetAnnouncementService.class, implementation = @Implementation(expression = "$pojoagent")))
@RequiredServices(
        @RequiredService(name = "produceser", multiple = true, type = IProduceService.class))
