package marsworld.carry;

import marsworld.SVector;
import marsworld.producer.ProduceOreTask;
import marsworld.sentry.AnalyzeTargetTask;
...
//	protected boolean	load;
     ...
     * @param listsner	The result listener to be informed when the destination
     * is reached. / public LoadOreTask(ISpaceObject target, boolean load,
     * IResultListener listener) { super(listener); this.target	= target;
     * this.load	= load;
	}
     */
